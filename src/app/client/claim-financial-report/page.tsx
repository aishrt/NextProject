...
export default async function ClaimFinancialReportsClient({
  searchParams,
}: {
  ...
  const fetchData = async (
    ...
    await db.connectDB();
    const totalUsers = await ClaimFinancialModel.countDocuments({});
  ...
  return (
    <div className="main-content client-docs">
      <div className="top-br">
        <h2 className="f-24">Claim Financial Report</h2>
      </div>
      <ClaimFilters />
