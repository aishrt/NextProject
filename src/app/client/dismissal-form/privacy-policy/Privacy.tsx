  ...
  return (
    <div>
      <div className="lease-form white-card p-4 mt-4 rounded">
        ...
        <p className="f-14">
          We understand that dealing with a dismissal or constructive dismissal
          and seeking compensation can be both stressful and overwhelming. This
          form is designed to simplify the process of collecting the essential
          information needed to assess your compensation request. Most users
          complete this form in about 15 minutes.
        </p>
        <h2 className="f-20 fw-500 mb-2">Why We Ask These Questions:</h2>
        ...
        <p className="f-14">
          ...
          dismissal or constructive dismissal. These questions are crucial
          because they help us understand your situation fully and ensure that
