...
const RequestDocTable = () => {
  ...
  return (
    <div className="cases-list-table expert-table req-documnet-table">
      ...
      <Table<any>
        ...
        columns={[
            ...
            Cell({ entry }) {
              return (
                <span>
                  <input
                    type="text"
                    className="form-control request-input-table"
                    name="f_name"
                  />
                </span>
              );
          ...
          },
          {
            ...
            Cell({ entry: {} }) {
              return (
                <span className="message-privately">
                  {" "}
                  <Button
                    className="bg-transparent p-0 border-0"
                    onClick={handleClickShow}
                  >
                    <Image src={message} className="mesage-icon" alt="" />{" "}
                  </Button>{" "}
                </span>
              );
            },
          },
          {
            ...
            Cell({ entry }) {
              return (
                <span>
                  <select className="form-select req-table-select">
            ...
            Cell({ entry: { _id } }) {
              return (
                <span className="add-request">
                  <span onClick={() => router.push(`/expert`)}>
                    <Button variant="contained" className="expert-btn w-max">
                      Add More
                    </Button>
                  </span>
                </span>
...
export default RequestDocTable;
