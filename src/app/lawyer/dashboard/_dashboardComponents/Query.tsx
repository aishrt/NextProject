  ...
  return (
    <div className="for-query my-4 d-flex flex-row-wrap">
      ...
      <div className="query-box purplebg" style={{backgroundColor: "#FFF9F6"}}>
        <p className="f-14 mb-2"><Image  className="send-icon" src={send} alt="send" /> Submit Evaluation</p>
        <h3 className="bold f-20 mb-0">Report <Image  className="arrow-lg" src={arrow} alt="arrow" />
        </h3>
      </div>
      <div className="query-box purplebg" style={{backgroundColor: "#FDC5ED"}}>
        <p className="f-14 mb-2"><Image  className="send-icon" src={send} alt="send" /> Submit Evaluation</p>
        <h3 className="bold f-20 mb-0">The Claim <Image  className="arrow-lg" src={arrow} alt="arrow" />
        </h3>
      </div>
